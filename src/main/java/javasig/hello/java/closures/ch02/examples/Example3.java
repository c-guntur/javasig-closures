...
public class Example3 {
    ...
    public void java8Style() {
        ...
        List<Double> cost = new ArrayList<>();
        //TODO: 1. Implement logic to calculate costAfterTax into the cost list per item.
        // ... Add code below.

        //TODO: 2. Create a Double total to sum up all costs.
        Double total = null; // Fix this null
